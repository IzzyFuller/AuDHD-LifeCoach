...
class TestCommitment:
    def test_commitment_creation(self):
        ...
        commitment = Commitment(
            start_time=start_time, end_time=end_time, who=who, what=what, where=where
        )
    ...
    def test_missing_required_arguments(self):
        ...
        with pytest.raises(TypeError):
            Commitment(
                end_time=datetime.now(), who="Friend", what="Call", where="Phone"
            )

        # Missing 'end_time'
        with pytest.raises(TypeError):
            Commitment(
                start_time=datetime.now(), who="Friend", what="Call", where="Phone"
            )
