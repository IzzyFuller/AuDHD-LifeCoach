...
class TestReminder:
    def test_reminder_creation(self):
        ...
        # Act
        reminder = Reminder(when=when, message=message, commitment=commitment)
    ...
    def test_reminder_from_commitment(self):
        ...
        assert (
            commitment.what in reminder.message
            or "commitment" in reminder.message.lower()
        )
        assert reminder.commitment == commitment
    ...
    def test_snooze_reminder(self):
        ...
        reminder = Reminder(
            when=original_time, message="Time to leave", commitment=commitment
        )
    ...
    def test_is_due(self):
        ...
        past_reminder = Reminder(
            when=past_time, message="Past reminder", commitment=commitment
        )
        future_reminder = Reminder(
            when=future_time, message="Future reminder", commitment=commitment
        )
