...
class TestRabbitMQMessagePublisher:
    ...
    def test_publish_message_with_publish_failure(self, mock_pika_connection, test_settings):
    ...
    def test_publish_message_custom_content_type(self, mock_pika_connection, test_settings):
